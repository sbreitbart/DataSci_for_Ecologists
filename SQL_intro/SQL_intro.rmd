...
1.  Dive deeper into the [`dbplyr` package](https://dbplyr.tidyverse.org/index.html)'s documentation to learn more about interfacing with SQL databases using R.
...
3.  Stretch your skills further with Ethan White and Zachary Brym's excellent ["Integrating R and SQL" assignment](https://rsh249.github.io/semester-biology/assignments/r-sql/).
...
```
<a class="btn" href="https://sbreitbart.github.io/SQL_tutorial/index.html"> Home </a>
