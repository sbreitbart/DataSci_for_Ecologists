...
**Where**: Virtual. [https://utoronto.zoom.us/j/86435491946](https://utoronto.zoom.us/j/86435491946)

Meeting ID: 864 3549 1946
Passcode: 656624
...
**Past events**: We have previously run a similar workshop at [SORTEE 2021](https://www.sortee.org/events/) and [CSEE 2021](https://csee-scee2021.ca/). 
...
```{r eval= FALSE}
install.packages(c("here", "magrittr", "performance", "patchwork", "ggplot2", "dplyr", "tidyr", "remotes"), dependencies = TRUE)
remotes::install_github("luisDVA/annotater")

```

**We also encourage you to make a new R project for this workshop if you plan on coding along with us!**
Read this short [introduction to R projects](https://swcarpentry.github.io/r-novice-gapminder/02-project-intro), courtesy of The Carpentries, and create an R project for this workshop by following a few simple steps [under the "Challenge 1: Creating a self-contained project" section](https://swcarpentry.github.io/r-novice-gapminder/02-project-intro/#challenge-1-creating-a-self-contained-project).
